...
<style>
 ...
 <body>
 <?php include('contatoreVisite.php');?>
<?php  
 # echo ("<a href='galImm/gallery.php'>Qui puoi consultare il riepilogo di tutte le foto</a>");
 $galImm="<a href='galImm/gallery.php' color=#CC2200>Qui puoi consultare il riepilogo di tutte le foto</a>";
 echo $galImm;
 ?>
<div id="map"></div>
<?php
...
if ($lat !== 0){
echo    "L.marker({lon:". $lon . ", lat:". $lat . "}). bindPopup('" . $dataora ."<br/><img width=100% src=img/". basename($filename) ."><br/>". basename($filename) ."').addTo(map);\n";
}}
echo ("</script>");
?>
<?php
